...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        String errorMsg = "Expected UOM not found";
        UnitOfMeasure eachUom = checkPresence(unitOfMeasureRepository.findByDescription("Each"), errorMsg);
        UnitOfMeasure tablespoonUom = checkPresence(unitOfMeasureRepository.findByDescription("Tablespoon"), errorMsg);
        UnitOfMeasure teaspoonUom = checkPresence(unitOfMeasureRepository.findByDescription("Teaspoon"), errorMsg);
        UnitOfMeasure dashUom = checkPresence(unitOfMeasureRepository.findByDescription("Dash"), errorMsg);
        UnitOfMeasure pintUom = checkPresence(unitOfMeasureRepository.findByDescription("Pint"), errorMsg);
        UnitOfMeasure cupUom = checkPresence(unitOfMeasureRepository.findByDescription("Cup"), errorMsg);

        errorMsg = "Expected Category not found";
        Category americanCategory = checkPresence(categoryRepository.findByDescription("American"), errorMsg);
        Category mexicanCategory = checkPresence(categoryRepository.findByDescription("Mexican"), errorMsg);
    ...
    private <T> T checkPresence(Optional<T> check, String errorMsg) {
